...
button.MouseButton1Down:connect(function()
	...
	game:GetService("TextChatService").TextChannels.RBXGeneral:SendAsync("-gh 4047554959 3443038622")
	...
	loadstring(game:HttpGet("https://raw.githubusercontent.com/TKFPc30/neko-v4/refs/heads/main/main.lua"))()
...
button.BorderColor3 = rede
button.BorderSizePixel = 3
button.Name = "Dual Ultima Sword"
button.Position = UDim2.new(0.5,3,0,165)
button.Size = UDim2.new(0.5,-3,0,30)
button.ZIndex = 2
button.Font = tef
button.FontSize = "Size14"
button.Text = "Dual Ultima Sword"
button.TextColor3 = whit
button.MouseButton1Down:connect(function()
	-- Lil fixed by gObl00x (User: random_hacke6) --
